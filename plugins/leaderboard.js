...
You: *${usersMoney.indexOf(m.sender) + 1}* of *${usersMoney.length}*
...
handler.help = ['leaderboard'].map(a => a + " *[get leaderboard]*")
handler.tags = ['rpg']
