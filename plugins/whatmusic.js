...
let acr = new acrcloud({
    ...
    access_key: '3f9d6a02b8752016c720d80fd629358c',
    access_secret: 'GhpagrJiQNhumKb28gyzjLbuSsG8zhphRp2Vodn0'
});
...
handler.tags = ['tools'];
handler.command = /^(whatmusic|whatsmusic|musikapa|whatmusik|detectmusic|deteksimusik|detectmusik|musikapaini)$/i;
