let handler = async (m, {
    ...
    if (!text) {
        var pesan = "Please be active in the group because there will be member cleaning every time."
    } else {
        var pesan = text
    }
    var sum
...
handler.tags = ['group']
handler.command = /^(gcsider|groupsider)$/i
handler.group = true
